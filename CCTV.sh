...
${RED}     .
 /\ /|
((.Y(!     Instagram : @mark.cornel97
 \ |/    WhatsApp : +2347013107449
${CYAN} /  6~6,   author : Mark Cornel
 \ _    +-.  github : GUPTA-SHAKEL
${GREEN}  \`-=--^-' powered by Mafia-Killer (TEAM)
   \ \
  \ 
"
}
